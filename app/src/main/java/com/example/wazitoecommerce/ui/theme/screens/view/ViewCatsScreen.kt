...
@Composable
fun ViewCatsScreen(navController:NavHostController) {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Row {
            ...
            Row(horizontalArrangement = Arrangement.SpaceEvenly,
                ...
                InfoCard(title = "$catage yrs", subtitle = "Age")
                Spacer(modifier = Modifier.width(20.dp))
                InfoCard(title = catcolor, subtitle = "Color")
                Spacer(modifier = Modifier.width(20.dp))
                InfoCard(title = "$catweight Kg", subtitle = "Weight")
            }
...
fun ViewCatsScreenPreview(){
    WazitoECommerceTheme {
        ViewCatsScreen(navController = rememberNavController())
    }
}