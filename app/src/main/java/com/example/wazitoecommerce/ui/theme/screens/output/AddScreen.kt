...
import com.example.wazitoecommerce.navigation.ADD_DOGS_URL
import com.example.wazitoecommerce.navigation.ADD_FISHS_URL
...
fun AddScreen(navController:NavHostController) {
    Column(modifier = Modifier
        ...
        TopAppBar(
            title = {
                Text(text = "Add A Pet", modifier = Modifier.fillMaxWidth(), textAlign = TextAlign.Center, fontWeight = FontWeight.ExtraBold, fontSize = 20.sp)
            },
            ...
            Card(
                ...
                Column {
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(200.dp).clickable { navController.navigate(ADD_DOGS_URL) },
            ...
            Card(
                ...
                Column {
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(200.dp).clickable { navController.navigate(ADD_CATS_URL) },
                        contentAlignment = Alignment.Center
                    ) {
                        Image(
            ...
            Card(
                ...
                Column {
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(200.dp).clickable { navController.navigate(ADD_BIRDS_URL) },
                        contentAlignment = Alignment.Center
                    ) {
                        Image(
            ...
            Card(
                ...
                Column {
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(200.dp).clickable { navController.navigate(ADD_FISHS_URL) },
                        contentAlignment = Alignment.Center
                    ) {
                        Image(
        ...
        Row {
            ...
            Card(
                ...
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(200.dp).clickable { navController.navigate(ADD_PETS_URL) },
                    contentAlignment = Alignment.Center
                ) {
                    Image(
