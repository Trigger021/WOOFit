...
@Composable
fun ViewDogsScreen(navController:NavHostController) {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Row {
            ...
            Row(horizontalArrangement = Arrangement.SpaceEvenly,
                ...
                InfoCard(title = "$dogage yrs", subtitle = "Age")
                Spacer(modifier = Modifier.width(20.dp))
                InfoCard(title = dogage, subtitle = "Color")
                Spacer(modifier = Modifier.width(20.dp))
                InfoCard(title = "$dogage Kg", subtitle = "Weight")
            }
...
fun ViewDogsScreenPreview(){
    WazitoECommerceTheme {
        ViewDogsScreen(navController = rememberNavController())
    }
}